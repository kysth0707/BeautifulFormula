...
2. You must use only one variable (in Real field)
...
$$\sum_{t_{tt}}^{\int_{-\frac{t}{t}}^{\frac{t}{t}}dt_{t}}t_{tt}=1+2=3$$
...
$$\ln \frac{t}{t}=0$$
$$\sum_{t_{ttt}=\ln \frac{t}{t}}^{\int_{-\frac{t}{t}}^{\frac{t}{t}}\int_{-\frac{t}{t}}^{\frac{t}{t}}dt_{t}dt_{tt}}\frac{x^{n}}{t_{ttt}!}=\sum_{n=0}^{4}\frac{x^{n}}{n!}\approx e^{x}$$
